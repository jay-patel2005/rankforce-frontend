        ...
        <div className="grid gap-12 pb-16 md:grid-cols-2 lg:grid-cols-4 lg:gap-8">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex gap-4">
              <a href="#" className="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 text-white/80 transition-colors hover:bg-primary hover:text-white" aria-label="Twitter">
                <TwitterIcon size={18} />
              </a>
              <a href="#" className="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 text-white/80 transition-colors hover:bg-primary hover:text-white" aria-label="LinkedIn">
                <LinkedinIcon size={18} />
              </a>
              <a href="#" className="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 text-white/80 transition-colors hover:bg-primary hover:text-white" aria-label="GitHub">
                <GithubIcon size={18} />
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4 text-[15px] text-white/70">
              ...
              <li>
                <Link href="/about" className="transition-colors hover:text-primary">About JD</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4 text-[15px] text-white/70">
              <li>
                <Link href="/services/local-seo" className="transition-colors hover:text-primary">Local SEO</Link>
              </li>
              <li>
                <Link href="/services/ecommerce-seo" className="transition-colors hover:text-primary">Ecommerce SEO</Link>
              </li>
              <li>
                <Link href="/services/technical-seo" className="transition-colors hover:text-primary">Technical SEO</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4 text-[15px] text-white/70">
              <li className="flex items-start gap-3">
                ...
                <a href="mailto:hello@rankwithjd.com" className="transition-colors hover:text-white">hello@rankwithjd.com</a>
              </li>
              <li className="flex items-start gap-3">
                <Phone size={20} className="mt-0.5 shrink-0 text-primary" />
                <a href="tel:+919876543210" className="transition-colors hover:text-white">+91 987 654 3210</a>
              </li>
              <li className="flex items-start gap-3">
