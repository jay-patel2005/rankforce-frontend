...
import { SocialAdsHeroDashboard } from '@/components/sections/services/social-ads/SocialAdsHeroDashboard';
import { 
  Target, 
  PenTool, 
  Share2, 
...
export const socialAdsData: ServicePageData = {
  slug: 'social-ads',

  hero: {
    badge: 'SOCIAL ADS SERVICES',
    titleHtml: (
    ...
    buttonLink: '/contact',
    rightComponent: <SocialAdsHeroDashboard />,
  },
  ...
  importance: {
    ...
    imageSrc: '/images/services/Social media Ads.webp', // Can use existing placeholder image or custom svg if needed
